...
class HavaWebsiteScroll_Widget extends WP_Widget {
    ...
    ?>    
        <a href="#" class="back-to-top" alt="scroll back to the top of the page button">
            <span class="glyphicon glyphicon-circle-arrow-up" alt="back to top icon arrow pointing up"></span>
        </a>
